    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-sand-50">
        <div className="text-center">
           ...
           <Link to="/courses"><Button>{language === 'vi' ? 'Quay lại danh sách' : 'Back to Courses'}</Button></Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-sand-50 pb-20">
      ...
      <div className="relative h-[40vh] md:h-[50vh]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-3xl md:text-5xl font-serif font-bold text-white text-center px-4 shadow-sm">{course.title[language]}</h1>
        </div>
        <div className="absolute top-6 left-6">
            <Link to="/courses" className="text-white hover:text-primary-light transition-colors flex items-center bg-black/20 p-2 rounded-full backdrop-blur-sm">
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-16 relative z-10">
         <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-sand-100">
             ...
             <div className="prose prose-stone max-w-none mb-10">
                 ...
                 <p className="text-lg text-stone-600 leading-relaxed mb-6">{course.description[language]}</p>
