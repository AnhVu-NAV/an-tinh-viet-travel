            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl">
                <div className="text-center">
                    <div className="flex justify-center mb-6">
                        <Image src="/logo.png" alt="An Tinh Viet" width={100} height={60} className="object-contain opacity-90" />
                    </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleLogin}>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="text-center text-sm text-stone-500">
                            ...
                            <button type="button" onClick={() => router.push("/register")} className="text-primary font-bold hover:underline">
