...
export default function LocationsClient({ locations }: { locations: LocationDTO[] }) {
    ...
    return (
        <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                    ...
                    {locations.map((loc, index) => (
                        ...
                        {tag}
                                ...
                                <div className="mt-auto pt-6 border-t border-sand-100 flex justify-between items-center">
                                    ...
                                    {/* tours page search param – giữ behavior cũ */}
                                    <Link
                ...
                {locations.length === 0 && (
                    <div className="text-center text-stone-400 italic py-16">No locations.</div>
                )}
            </div>
        </div>
    );
